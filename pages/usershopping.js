    ...
    emailjs
      ...
      .then(
        (result) => {
          ...
          alert(
            "Your Order Was Successfully Placed, Kindly Check your Email for your Invoice we will contact you shortly. Thanks "
          );
          event.target.reset();
        },
        (error) => {
        ...
        <form className={classes.form} onSubmit={submitHandler} ref={form}>
          ...
          <div className={classes.userItem}>
            ...
            <div className={classes.product}>
              <label htmlFor="user_products">Items Purchased</label>
              <br />
              <br />
              <textarea
                required
              ...
              <label htmlFor="user_qty">Respective Quantities</label>
              <br />
              <br />
              <input
                required
          ...
          <div className={classes.control}>
            ...
            <select name="user_city" id="city" ref={cityInputRef} required>
